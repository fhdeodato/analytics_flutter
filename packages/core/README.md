...
| `trackPushNotifications`          | false                         | Enable automatic tracking for [push notifications events](https://segment.com/docs/connections/sources/catalog/libraries/mobile/ios/#automatic-push-notification-tracking): Push Notification Received and Push Notification Tapped)                                                                                                 |
